/* Shared: 3D dice + recursive glossary engine */
  ...
  var GLOSSARY = {
    ...
    "dmg-fire":{term:"Fire",def:"Damage from flame and searing heat — burning hands, a dragon's breath, a torch."},
    "dmg-cold":{term:"Cold",def:"Damage from freezing temperatures — an ice storm, a frost spell, the deep cold."},
    "dmg-lightning":{term:"Lightning",def:"Damage from electricity — a lightning bolt, a shocking grasp, a live wire."},
    "dmg-thunder":{term:"Thunder",def:"Damage from a concussive boom or shockwave — a thunderwave, a bell's blast."},
    "dmg-acid":{term:"Acid",def:"Damage from corrosive substances that burn and dissolve — a black dragon's spray, a vial of acid."},
    "dmg-poison":{term:"Poison",def:"Damage from toxins and venom — a serpent's bite, a poisoned blade, noxious fumes. Often paired with the Poisoned condition."},
    "dmg-necrotic":{term:"Necrotic",def:"Withering damage that saps life force — the touch of undeath, a vampire's drain, decay magic."},
    "dmg-radiant":{term:"Radiant",def:"Searing divine or celestial energy — burning light from holy magic that sears body and soul."},
    "dmg-psychic":{term:"Psychic",def:"Damage to the mind rather than the body — a mental assault that bypasses armor entirely."},
    "dmg-force":{term:"Force",def:"Pure magical energy given shape — a magic missile or spiritual weapon. Almost nothing resists it."},
  ...
  var ALIASES = {
    ...
    "fire damage":"dmg-fire","cold damage":"dmg-cold","lightning damage":"dmg-lightning","thunder damage":"dmg-thunder","acid damage":"dmg-acid","poison damage":"dmg-poison","necrotic damage":"dmg-necrotic","radiant damage":"dmg-radiant","psychic damage":"dmg-psychic","force damage":"dmg-force",
    "radiant":"dmg-radiant","necrotic":"dmg-necrotic","psychic":"dmg-psychic",
